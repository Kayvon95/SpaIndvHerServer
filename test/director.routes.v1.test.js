        ...
        it('should return all directors from MongoDB', (done) => {
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    // console.log('ID found: ' + res.body[0]._id);
                    this.id = res.body[0]._id.toString();
       ...
       it('should edit a director and return it', (done) => {
        ...
        it('it should add a movie to a directors and return it', (done) => {
            chai.request(server)
                ...
                .send({title: 'TestMovie', subtitle: 'test subtitle', minutes: 124, genre: 'Action', yearOfRelease: 2015, imageUrl: 'testurl.nl/foto.jpg'})
                .end((err, response) => {
